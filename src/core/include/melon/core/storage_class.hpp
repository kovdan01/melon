...
public:
    ...
    void set_domain_id(std::uint64_t new_domain_id)
    {
...
public:
    ...
    void set_user_id(std::uint64_t new_user_id)
    {
...
public:
    ...
    void set_message_id(std::uint64_t new_message_id)
    {
    ...
    void set_chat_id(std::uint64_t new_chat_id)
    {
