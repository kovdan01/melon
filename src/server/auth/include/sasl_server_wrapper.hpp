...
public:
    ...
    mca::StepResult start(std::string_view chosen_mechanism, std::span<const melon::core::byte_t> client_initial_response);
    mca::StepResult step(std::span<const melon::core::byte_t> client_response);
